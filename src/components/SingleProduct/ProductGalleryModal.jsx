          ...
          >
            ...
            >
              <button
                type="button"
                onClick={onClose}
                className="absolute top-4 right-4 z-50 w-11 h-11 flex items-center justify-center rounded-full text-2xl opacity-80 hover:opacity-100 transition"
                style={{
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            className={`fixed top-6 left-1/2 -translate-x-1/2 z-[10000] w-[90%] max-w-[520px] px-4 py-3 rounded-xl text-[13px] font-medium ${
              theme === "dark"

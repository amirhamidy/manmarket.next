...
const SHOW_INTERVAL_MS = 5 * 60 * 1000;
const STORAGE_KEY = "downloadModalLastShown";
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center gap-1 mb-6">
                                ...
                                <span className={`text-[11px] ${isDark ? "text-white/45" : "text-gray-400"}`}>
                            ...
                            <div className="grid grid-cols-4 gap-3">
                                {downloadOptions.map((option) => (
                                    <motion.a
                                        ...
                                        whileTap={{ scale: 0.93 }}
                                        className={`grid grid-cols-1 items-center gap-2 py-3 px-1 rounded-2xl transition-colors duration-150`}
                                    >
                                        <img
                                            src={option.icon}
                                            alt={option.label}
                                            className=" w-3xl object-contain rounded-xl"
                                        />
                                        <span

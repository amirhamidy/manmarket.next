...
export default function ProductCard({ product, isUnavailable }) {
    ...
    >
      ...
      >
        {loading ? (
          <>
            <div
              className={`w-full h-[120px] rounded-xl ${theme === "dark" ? "bg-gray-600" : "bg-gray-300"} animate-pulse`}
            />
            <div
              className={`mt-3 h-4 w-3/4 rounded-full ${theme === "dark" ? "bg-gray-600" : "bg-gray-300"} animate-pulse`}
            />
            <div
              className={`mt-2 h-4 w-1/3 rounded-full ${theme === "dark" ? "bg-gray-600" : "bg-gray-300"} animate-pulse`}
            />
          </>
        ) : (
          <>
            ...
            <div className="flex items-center justify-between w-full mt-2">
              <div className="flex items-center">
                ...
                <span
                  className="text-[#ff7643] text-[13px] mr-0.5"
                ...
                >
                  ...
                  <meta
                    ...
                    content={String(product.avg_rate || 0)}
                  />
              ...
              {isUnavailable ? (
                <span className="text-red-500 text-xs font-bold">ناموجود</span>
              ) : (
                <span
                  className="text-[#ef5350] text-[13px]"
                  itemProp="offers"
                  itemScope
                ...
                >
                  <div className="flex gap-0.5 items-center whitespace-nowrap">
                    ...
                    <meta
                      itemProp="price"
                      content={String(product.min_price || 0)}
                    />

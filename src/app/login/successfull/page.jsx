    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-center max-w-[556px] w-full mx-auto p-4 relative">
            <section className="flex flex-col items-center">
                ...
                <div className="text-center mb-2 text-[18px] text-gray-700">ورود موفقیت‌آمیز بود</div>
                <div className="text-center text-[13px] text-[#ff7643]">شما با موفقیت وارد شدید</div>
            </section>

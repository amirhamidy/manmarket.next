    ...
    <div className="relative w-full overflow-hidden rounded-3xl">
      <div className="relative z-10 h-full">
        ...
        >
          ...
          <div className="flex flex-col justify-start text-[12px] space-y-3 flex-1 px-2 overflow-hidden">
            <div className={`h-4 rounded w-4/5 ${pulse}`} />
            <div className="flex flex-wrap gap-2">
              <div className={`h-3 rounded w-14 ${pulse}`} />
              <div className={`h-3 rounded w-16 ${pulse}`} />
              <div className={`h-3 rounded w-12 ${pulse}`} />
            </div>
          </div>
          <div className="flex flex-col items-center justify-between h-[80px] mx-2">
            <div className={`w-6 h-6 rounded-full ${pulse}`} />
          ...
          const mappedItems = await Promise.all(
            cartData.cart_items.map(async (item) => {
              try {
                ...
                const colorInv = prodData.color_inventories.find(
                  (c) => c.id === item.color_inventory,
                );
                const colorName =
                  colorInv?.color?.title || colorInv?.title || "نامشخص";
                const productImage =
                  prodData.product_images.find(
                ...
                return {
                  ...
                  ram:
                    prodData.specifications.find((s) => s.name.includes("RAM"))
                      ?.value || "",
                  memory:
          ...
          {loading ? (
            ...
            >
              <svg
                ...
                width="64"
                height="57.599"
                viewBox="0 0 64 57.599"
              >
                <path
                  d="M65.429,17.568a3.176,3.176,0,0,0-2.63-1.417H19.065L15.372,7.044A6.38,6.38,0,0,0,9.465,3H2V9.576H9.465l15.18,37.431A3.2,3.2,0,0,0,27.6,49.029H53.2a3.212,3.212,0,0,0,3-2.13l9.6-26.3A3.364,3.364,0,0,0,65.429,17.568Z"
                  fill={theme === "dark" ? "#777" : "#757575"}
                />
                <circle
                  cx="4.009"
                  cy="4.009"
                  r="4.009"
                  transform="translate(22.519 49.58)"
                  fill={theme === "dark" ? "#777" : "#757575"}
                />
                <circle
                  cx="4.009"
                  cy="4.009"
                  r="4.009"
                  transform="translate(45.038 49.58)"
                  fill={theme === "dark" ? "#777" : "#757575"}
                />
              </svg>
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      dir="ltr"
                      className={`flex justify-start items-center rounded-3xl px-2 ${shadow}`}
                      style={{
                        minHeight: "120px",
                        width: "100%",

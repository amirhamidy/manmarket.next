...
export default function AboutUs() {
  ...
  return (
    ...
    >
      ...
      <main
        dir="rtl"
        className="flex flex-col items-start max-w-[556px] w-full px-4"
      >
        <p
          className={`my-1 py-1 leading-8 text-sm ${
        ...
        <h5
          className={`my-1 py-1 text-lg font-semibold ${
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 py-3">
          {docs.map((doc, i) => (
            <a
              ...
              className={`flex flex-col items-center justify-center hover:opacity-80 transition-opacity p-4 border rounded-xl ${
                isDark
                  ? "text-gray-100 border-white/10 bg-[#141414]"
            ...
            >
              ...
              />
              <span
                className={`my-3 text-sm text-center ${

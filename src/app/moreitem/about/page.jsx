  ...
  return (
    <div className="flex justify-center items-center flex-col ">
      ...
      >
        ...
        <p className="my-1 py-1 text-gray-600 leading-8 text-sm">
        ...
        <h5 className="my-1 py-1 text-lg font-semibold text-gray-800">
          چرا من مارکت؟
        </h5>
        ...
        {[
          ...
          <p key={i} className="my-1 py-1 text-gray-600 leading-8 text-sm">
            {text}
          </p>
        ))}

...
export default function Custom403() {
    return (
        <main className="min-h-screen flex flex-col max-w-[556px] w-full mx-auto  items-center justify-center p-4 relative">
            <section className="flex flex-col items-center">
                ...
                <div className="text-center text-[14px] text-[#ff7643]">
                    <span>متاسفیم، شما اجازه دسترسی به این صفحه را ندارید</span>
                </div>
            </section>

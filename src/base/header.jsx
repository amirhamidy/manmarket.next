...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        {loading ? (
          <div className="w-[22px] h-[22px] bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse"></div>
        ) : (
          <Image
            src="/logo.png"
            alt="Logo"
            ...
            height={22}
            className={clsx(
              "w-[25px] h-[25px] object-contain brightness-60 invert transition-all duration-300",
              theme === "dark" && "",
            )}
          />
        )}
